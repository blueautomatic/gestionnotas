...
$this->pageTitle=Yii::app()->name . ' - Elementos enviados';
...
$this->widget('zii.widgets.CListView', array(
	...
	'emptyText' => '<span style="width:190px;padding:10px;position:absolute;left:50%;top:28%;background-color: #ccc;">No hay notas enviadas.</span>',
	'id'=>'clistview-nota',

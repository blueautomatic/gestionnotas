...
<div class="form" style="width:1200px;">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<?php echo $form->errorSummary(array($model,$modelpro,$modeldoc)); ?>
			...
			<?php } else { ?>
				...
				<div id="row-col">
					<div class="row">
						...
						<?php 
							if($model->get_browser_name($_SERVER['HTTP_USER_AGENT']) == "Firefox")
								echo '<div class="notas-field-container">' . $form->textArea($model,'nronota',array('class'=>'a','readonly'=>'readonly','value'=>'-')) . '<div class="notas-field">/' . date("Y") . '</div></div>'
						?>
						<?php 
							if($model->get_browser_name($_SERVER['HTTP_USER_AGENT']) == "Chrome")
								echo '<div class="notas-field-container">' . $form->textArea($model,'nronota',array('class'=>'b','readonly'=>'readonly','value'=>'-')) . '<div class="notas-field">/' . date("Y") . '</div></div>'
						?>
						<?php echo $form->error($model,'nronota'); ?>
					</div>
				</div>
		...
		<div id="prov-docadj" style="margin-top:18px;width:510px !important;float:right !important;">
			<div class="row" style="display:inline-block;">
				...
				<?php $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
					...
					'model'=>$modelpro,
					'value'=>$modelpro->isNewRecord ? /*$this->createUrl('proveedores/crear')*/'' : $model->idproveedor0->nombre,
			...
			<!--<div class="row" style="margin-top:28px;">
				...
				<?php #echo $form->textField($modelseg,'idnota_referencia',array('style'=>'background-color:white;border:1px solid #89aed3;')); ?>
		...
		<div class="row buttons" style="margin-top:80px !important;margin-left: 70px;display:block !important;clear:both;">
			<?php echo CHtml::submitButton($model->isNewRecord ? 'Cargar' : 'Cargar', array('class'=>'answer')); ?>
		</div>

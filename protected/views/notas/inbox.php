...
$this->pageTitle=Yii::app()->name . ' - Notas recibidas';
...
<h1>Notas recibidas</h1>
<br />
<?php echo CHtml::link("Exportar a Excel",array("notas/excel"),array('class'=>'answer')); ?>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'summaryText' => 'Viendo {start}-{end} de {count} notas recibidas.',
	...
	'columns'=>array(
		...
		array(
			...
			'htmlOptions'=>array('style'=>'width: 455px !important;height: auto !important;white-space: nowrap;display:block;overflow:hidden;text-overflow:ellipsis;'),
		),
		/*array(
			'header'=>'Importe',
		...
		array(
			...
			'name'=>'origen',
			'value'=>'Areas::model()->findByPk($data->origen)->nombre',

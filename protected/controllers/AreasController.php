...
class AreasController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow admin users to perform all actions
				...
				'roles'=>array('administrador_areas'),
			),
			array('allow',  // allow admin users to perform all actions
				'actions'=>array(/*'index','view','modificar',*/'autocomplete'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Areas']))
		{
			...
			if($model->save())
			{
				Yii::app()->user->setFlash('success', "Se ha guardado la nueva área.");
	...
	public function actionModificar($id)
	{
		...
		if(isset($_POST['Areas']))
		{
			...
			if($model->save())
			{
				Yii::app()->user->setFlash('success', "Se ha modificado exitosamente.");
				$this->redirect(array('view','id'=>$model->id));
			}
		}

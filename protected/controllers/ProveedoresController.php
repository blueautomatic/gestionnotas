...
class ProveedoresController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow admin users to perform all actions
				'actions'=>array('index','view','crear','update','admin','delete'),
	 ...
	 */
	public function actionCrear($term)
	{
		...
		if(isset($_GET['term'])
		{
			$model->nombre=$_GET['term'];
			$model->save();
			var_dump(gettype($model->nombre)); var_dump($model->nombre); Yii::app()->end();
			/*if($model->save())

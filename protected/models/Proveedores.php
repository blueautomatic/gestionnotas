...
class Proveedores extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombre, direccion, email', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, direccion, telefono, email', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'notasProveedores' => array(self::HAS_MANY, 'NotasProveedores', 'idproveedor'),
		);
	}
